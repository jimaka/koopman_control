...
from koopman import HorizontalKoopmanModel, HorizontalKoopmanModelV3, FEATURE_DICT_ATOMS
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--test_data", type=str, default=str(P.TEST))
    p.add_argument("--ckpt_dir", type=str, default=str(P.CKPT_DIR))
    p.add_argument("--log_dir", type=str, default=str(P.LOG_DIR))
    p.add_argument("--out_dir", type=str, default=str(P.EVAL_OUT_DIR / "v2"))
    ...
    p.add_argument("--baseline_ckpt", type=str, default=str(P.CKPT_V1_BEST),
