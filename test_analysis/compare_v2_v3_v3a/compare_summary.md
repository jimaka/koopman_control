...
| v3a | checkpoints/koopman_v3a_best.pth | 35622 | 20 | 0.00664257 | 0.00124291 | 0.00419442 | 0.00643705 | 0.0115533 | 0.0110829 | 0.00326313 | 0.000779924 | 0.00606437 | 0.0134834 | 9.29534 | 0.706609 | 0.000498022 | 0.117343 | 0.00632267 | True | 1.29212 | 89.2791 | 3.89143e-06 | 0.000128578 | 4.82772e-05 | 0.00891798 | 0.0181237 | 0.023077 | 0.0328591 | 0.999737 | 0.999953 | 0.999558 | 0.999869 | 0.999983 | 0.999897 |
...
- `vel_rmse_step_20`: 0.0256436 → 0.0115533  (↓ +54.9%)
- `slope_loglog`: 0.991456 → 0.706609  (↓ +28.7%)
- `instability_score`: 2.15294 → 1.29212  (↓ +40.0%)
...
### §5 PROMPT_v3a 14 条阈值逐条判定 (test set, K=20)

| # | 指标 | v2 | v3 | v3a 实测 | 阈值 | 判定 |
|---|---|---|---|---|---|---|
| G1 | vel_rmse_step_K | 0.016059 | 0.0110681 | 0.0115533 | ≤ 0.01285 | ✅ |
| G2 | u_rmse_step_K | 0.0158045 | 0.0101008 | 0.0110829 | ≤ 0.01185 | ✅ |
| G3 | |u_bias_mean| | 0.00255312 | 0.000378947 | 3.89143e-06 | ≤ 0.00153 | ✅ |
| G4 | slope_loglog | 0.669505 | 0.711627 | 0.706609 | ≤ 0.6695 | ❌ |
| G5 | instability_score | 1.23633 | 1.28117 | 1.29212 | ≤ 1.2363 | ❌ |
| V1 | v_rmse_step_K (plan-A) | 0.00284718 | 0.00452493 | 0.00326313 | ≤ 0.00342 | ✅ |
| V2 | |v_bias_mean| (plan-A) | 0.000351623 | 0.000154354 | 0.000128578 | ≤ 0.0004 | ✅ |
| S1 | per_segment.worst_vel_rmse_K | 0.0196107 | 0.0141883 | 0.0135493 | ≤ 0.01569 | ✅ |
| S2 | per_segment.ratio_worst_over_best | 3.46597 | 2.21534 | 1.80331 | ≤ 2.78 | ✅ |
| S3 | per_segment.high_speed_seg_mean | 0.0141173 | 0.00867062 | 0.00954463 | ≤ 0.01144 | ✅ |
| S4 | degraded_pct (vs v1) | nan | nan | 26.4247 | ≤ 20 | ❌ |
| N1 | vel_rmse_step_1 | 0.00184738 | 0.00121624 | 0.00124291 | ≤ 0.0024 | ✅ |
| N2 | traj_xy_rmse_step_K | 0.020081 | 0.0141993 | 0.0134834 | ≤ 0.02108 | ✅ |
| N3 | spectral_radius (I+A) | nan | nan | 0.996301 | ≤ 1.005 | ✅ |

**FAIL** — §5 PROMPT_v3a 14 条阈值。

### PROMPT_v3a A1+A2+A3 三件事归因（v3a vs v3，全部来自 summary.json）

| 维度 | v2 | v3 | v3a | v3a/v3 | 说明 |
|---|---|---|---|---|---|
| A1: v_rmse@K | 0.00284718 | 0.00452493 | 0.00326313 | 0.721144 | A1 直接目标，越低越好 |
| A1: |v_bias| | 0.000351623 | 0.000154354 | 0.000128578 | 0.833006 | A1 副指标 |
| A2: slope_loglog (G4) | - | 0.711627 | 0.706609 | 0.992949 | composite_v3a 显式加罚 |
| A2: instability (G5) | - | 1.28117 | 1.29212 | 1.00855 | composite 中 max(1, inst) |
| A3: worst_seg vel@K (S1) | - | 0.0141883 | 0.0135493 | 0.954961 | seg_resample 直接目标 |
| A3: high_speed_seg_mean (S3) | - | 0.00867062 | 0.00954463 | 1.1008 | seg_resample 衍生效果 |
| 总:vel_rmse@K (G1) | 0.016059 | 0.0110681 | 0.0115533 | 1.04384 | 总精度指标 |
